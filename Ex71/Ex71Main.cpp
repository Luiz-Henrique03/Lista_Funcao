...
para representar um ponto em uma grade 2D, implemente uma func¸ao que indique se um ˜
ponto p esta localizado dentro ou fora de um retangulo. O retangulo ˆ e definido por seus ´
vertices inferior esquerdo v1 e superior direito v2. A func¸ ´ ao deve retornar 1 caso o ponto ˜
